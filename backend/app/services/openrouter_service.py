...
If the product is women's clothing or any apparel worn by a female model — including, but not limited to, dresses, blouses, manteaux, hijabs, shawls, scarves, skirts, pants, lingerie, swimwear, sportswear, abayas, chadors, tunics, kaftans, jumpsuits, and any women's outerwear or innerwear — you MUST censor the visible human body parts of the female model (face, hair, neck, throat, chest, cleavage, shoulders, arms, hands, midriff, navel, hips, legs, knees, ankles, feet, and any visible skin) by applying a strong gaussian blur OR a discreet skin-tone-matched solid mask to the skin/hair regions only. Do NOT delete the person, do NOT remove the body, and do NOT replace the model with a ghost-mannequin. Keep the model's pose, silhouette, and the way the garment falls on the body intact so the buyer can see fit, drape, and proportions.
Apply the blur/mask ONLY on skin and hair regions; the garment itself must stay sharp and unblurred so its fabric texture (see rule above) remains fully visible.
